...
(def-doom-theme mylight
                ...
                ((lsp-face-highlight-textual :background base1 :foreground fg-alt :distant-background bg-alt)
                 ...
                 (vterm-color-black               :foreground palette0F :background palette09)
                 (vterm-color-red                 :foreground palette18 :background palette17)
                 (vterm-color-green               :foreground palette47 :background palette45)
                 (vterm-color-yellow              :foreground palette35 :background palette34)
                 (vterm-color-blue                :foreground palette68 :background palette66)
                 (vterm-color-magenta             :foreground palette78 :background palette77)
                 (vterm-color-cyan                :foreground palette57 :background palette55)
                 (vterm-color-white               :foreground palette0F :background palette09)
                 ...
                 (vi-tilde-fringe-face             :foreground violet :background orange)))
